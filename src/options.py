...
class Options(object):
    ...
    def parse(self, command):
        ...
        try:
            opts, args = getopt.getopt(command[1:],
                                    '1a:bBc:C:de:hl:mM:np:r:s:t:u:vwx',
                                    ['accy=',
                                        'am1',
                                        'approach=',
                                        'approx=',
    ...
    def usage(self):
        ...
        print('                                   Available values: perfect, sparse (default = perfect)')
        ...
        print('        --clsorder=<string>        Measure to sort classes')
        print('                                   Available values: maj, cost, acry (default = maj)')
        print('        --clsdown                  Reversely sorting classes')
        ...
        print('        -M, --mode=<string>        Mode to compute DLs')
        print('                                   Available values: sep, complete (default = sep)')
